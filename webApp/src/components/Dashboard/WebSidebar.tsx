...
export const WebSidebar: React.FC<WebSidebarProps> = ({ activeSection, onSelectSection, userDisplayName }) => {
  const navItems = [
    ...
    { id: 'Cash Book', label: 'Cash Book', icon: (
      <svg className="sidebar-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <aside className="crm-sidebar">
      <div className="sidebar-header">
        ...
        <div>
          ...
          <div className="sidebar-user-sub">Administrator v2.1.0</div>
        </div>
      </div>
