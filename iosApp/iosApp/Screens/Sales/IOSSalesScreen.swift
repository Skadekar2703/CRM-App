...
struct IOSPosView: View {
    ...
    private let products = [
        ...
        IOSProduct(id: "p3", name: "Silk Dupatta Special", sku: "TEX-003", category: "Textiles", price: 950, stock: 5),
        IOSProduct(id: "p4", name: "Brass Door Handle Heavy", sku: "HDR-101", category: "Hardware", price: 650, stock: 80),
        IOSProduct(id: "p5", name: "Stainless Steel Hinges Set", sku: "HDR-102", category: "Hardware", price: 320, stock: 3),
        IOSProduct(id: "p6", name: "LED Ceiling Light 15W", sku: "ELE-201", category: "Electronics", price: 480, stock: 0)
    ]

    var filteredProducts: [IOSProduct] {
        products.filter { p in
            let matchesSearch = searchQuery.isEmpty || p.name.localizedCaseInsensitiveContains(searchQuery) || p.sku.localizedCaseInsensitiveContains(searchQuery)
                        ...
                        ForEach(categories, id: \.self) { cat in
                            Button(action: { selectedCategory = cat }) {
                                Text(cat)
                                    ...
                                    .padding(.vertical, 8)
                                    .background(selectedCategory == cat ? Color(red: 15/255, green: 23/255, blue: 42/255) : Color.white)
    ...
    var body: some View {
        HStack {
            VStack(alignment: .leading, spacing: 2) {
                ...
                Text(customer).font(.subheadline).fontWeight(.semibold)
